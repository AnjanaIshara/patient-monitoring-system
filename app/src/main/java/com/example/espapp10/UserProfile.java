      ...
      /*  password = findViewById(R.id.password_profile);*/
       ...
       /*mRef3.addValueEventListener(new ValueEventListener() {
           ...
           public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               if(status.getCurrent().toLowerCase().equals("falling")){
                   //Toast.makeText(getApplicationContext(),status.getCurrent(),Toast.LENGTH_SHORT).show();
                   String message="The patient has fallen down.";
                   NotificationCompat.Builder builder=new NotificationCompat.Builder(
                           UserProfile.this
                   ).setSmallIcon(R.drawable.ic_baseline_accessible)
                   ...
                   //Toast.makeText(getApplicationContext(),"not falling",Toast.LENGTH_SHORT).show();
        ...
        //end of the push notification section
