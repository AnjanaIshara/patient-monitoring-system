...
public class Mean extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef3=FirebaseDatabase.getInstance().getReference("Location/Status");
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                int count = stk.getChildCount();//This section clears the previous drawn rows in the table
                for (int i = 0; i < count; i++) {
                    View child = stk.getChildAt(i);
                    if (child instanceof TableRow) ((ViewGroup) child).removeAllViews();
                }
                TableRow tbRow=new TableRow(Mean.this);
                //Setting up the table headers
                TextView roomName=new TextView(Mean.this);
                roomName.setText("Location");
                roomName.setTextColor(Color.BLUE);
                roomName.setTextSize(23f);
                roomName.setGravity(Gravity.CENTER);

                TextView Probability=new TextView(Mean.this);
                Probability.setText("Probability");
                Probability.setTextColor(Color.BLUE);
                Probability.setTextSize(23f);
                Probability.setGravity(Gravity.CENTER);

                tbRow.addView(roomName);
                tbRow.addView(Probability);
                stk.addView(tbRow);
               ...
               // lLayout.removeAllViews();
                ...
                for(int c=0;c<Room.size();c++){
                    ...
                    TableRow ChildRows=new TableRow(Mean.this);
                    TextView ChildRoomName=new TextView(Mean.this);
                    TextView ChildProbability=new TextView(Mean.this);
                    ChildRoomName.setText(spaceProbes[c][0]);
                    ChildRoomName.setTextColor(Color.BLACK);
                    ChildRoomName.setTextSize(20f);
                    ChildRoomName.setGravity(Gravity.CENTER);
                    ChildRows.addView(ChildRoomName);



                    ChildProbability.setText(spaceProbes[c][1]);
                    ChildProbability.setTextColor(Color.BLACK);
                    ChildProbability.setTextSize(20f);
                    ChildProbability.setGravity(Gravity.CENTER);


                    ChildRows.addView(ChildProbability);
                    stk.addView(ChildRows);
